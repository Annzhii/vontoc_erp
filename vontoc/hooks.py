...
fixtures = ["Print Format", "Client Script", "Workflow", "Workflow State", "Property Setter", "Item Group", "Document Naming Rule", "Report", "Payment Term", "Letter Head", "Payment Terms Template", "Terms and Conditions", "Print Settings", "User Permission"]
